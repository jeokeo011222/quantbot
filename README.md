...
**👉 [下载 QuantBot v1.4.0（Windows x64，ZIP 免安装包）](https://github.com/jeokeo011222/quantbot/releases/download/v1.4.0/QuantBot-v1.4.0.zip)**
...
[![Release](https://img.shields.io/badge/Release-v1.4.0-2ea44f)](https://github.com/jeokeo011222/quantbot/releases/download/v1.4.0/QuantBot-v1.4.0.zip)
...
```bash
# 1. 下载解压
# 下载地址：https://github.com/jeokeo011222/quantbot/releases/download/v1.4.0/QuantBot-v1.4.0.zip
...
| **历史研究数据** | 本地 DuckDB（全市场近 1 年日 K、复权因子、交易日历） |
