module github.com/quantpilot/quantpilot
...
require (
	...
	github.com/quant1x/num v0.7.5 // indirect
	github.com/quant1x/pkg v0.8.1 // indirect
	github.com/quant1x/x v0.1.25 // indirect
...
// 本地修复 quant1x/exchange 的交易日历越界 panic（TradeRange/transactionDateRange 中
// sort.SearchStrings 返回插入位置可能等于 len，导致 tradeDates[ie] 越界）
replace github.com/quant1x/exchange => ./third_party/exchange
